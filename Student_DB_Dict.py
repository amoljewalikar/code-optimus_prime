...
To exit press '6' :")#To display Dict press 5:
    i=int(input())
    if i==1:
        ...
        if roll not in std:
            ...
            if int(std[roll]['Marks']['Maths']) < 40 or int(std[roll]['Marks']['Science']) < 40 or int(std[roll]['Marks']['English']) < 40\
               or int(std[roll]['Marks']['Programming']) < 40 or int(std[roll]['Marks']['Electronics']) < 40:
                print("\nName:",std[roll]['Name'],"Percentage : ",per,"Grade : F ")
            else:
                if per>=75:
                    print("\nName:",std[roll]['Name'],"Percentage : ",per,"Grade : O ")
                elif per>=65 and per<75:
                    print("\nName:",std[roll]['Name'],"Percentage : ",per,"Grade : A ")
                elif per>=55 and per<65:
                    print("\nName:",std[roll]['Name'],"Percentage : ",per,"Grade : B ")
                elif per>=50 and per<55:
                    print("\nName:",std[roll]['Name'],"Percentage : ",per,"Grade : C ")
                elif per>=45 and per<50:
                    print("\nName:",std[roll]['Name'],"Percentage : ",per,"Grade : D ")
                elif per>=40 and per<45:
                    print("\nName:",std[roll]['Name'],"Percentage : ",per,"Grade : E ") 
    elif i==6:
        break
